        ...
        <v-row>
          ...
          <v-col cols="12" sm="6" md="6">
            <div class="containerStartSession">
              <h1 class="txtTitleLogin">Restablecer contraseña</h1>
              ...
              <v-form ref="formLogin " class="mt-6">
                <v-row>
                  ...
                  <v-col cols="12" sm="10" md="10">
                    ...
                    <span class="labelForm">Repetir contraseña</span>
                    <v-text-field
                      label="Solo"
                      placeholder="Contraseña"
                      v-model="password2"
  ...
  methods: {
    login() {
      if (this.password1 == this.password2) {
        ...
        this.loginForm.code = localStorage.getItem("code");
        ...
        this.showCircularProgress = false;
        // this.errorLogin = true;
        this.descriptionLoginError = "las contraseñas no son iguales";
        this.watchError();
      }
    },
    watchError() {

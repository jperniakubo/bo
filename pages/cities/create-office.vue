            ...
            <v-card-title>
              <v-row class="pl-4 pr-4">
                ...
                <v-col cols="4">
                  ...
                  <v-text-field solo v-model="inputName" :rules="[rules.required]" label="Nombre"></v-text-field>
                ...
                <v-col cols="4">
                  <label for="" class="font-weight-regular">Foto de la oficina</label>
                  <input
                    class="classicInput"
                    type="file"
                    style="display: none"
                  ...
                  <v-card outlined v-if="images.length == 0">
                    ...
                    <v-card-text class="px-16 text-center">
                      ...
                      Recuerda subir imágenes JPG <br> de máximo 1000 x 800 píxeles <br> y que no superen un peso de 1MB.
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        min: v => v.length >= 8 || 'El campo debe tener al menos 4 caracteres',
  ...
  methods: {
        ...
        image.onload = function () {
          ...
          if (height > 800 || width > 1000) {
            ...
            if (self.showError) {
              self.images = [
                " " +
                  self.product.productImage[0].image,
              ];
            } else {
              self.images = [];
            }
    ...
    deleteAllImages() {
      ...
      this.images = [
        " " + this.product.productImage[0].image,
      ];
    ...
    async createOfficeType() {
      ...
      const response = await this.$store.dispatch(
        "officeType/createOfficeType",
        {
          name: this.inputName,
          description: this.inputDescription,
          main: this.photosSelected[0],
          acstkn: localStorage.getItem("acstkn"),
          positions: this.positionsOfficeType,

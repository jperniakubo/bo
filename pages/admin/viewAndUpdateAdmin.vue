                ...
                <!-- <v-col cols="6" class="colsFields">
                  <div>
                    ...
                    <v-text-field
                      ...
                      class="classicInput"
                      v-model="password"
                      :rules="password || newPassword || confirmPassword ? passwordRules : withoutRules"
...
export default {
  ...
  mounted() {
    ...
    this.editAdminId = localStorage.getItem("editAdminId");
    this.getAdminData();
        ...
        .then(response => {
          ...
          if (response.code === 100 && response.success == true) {
            ...
            if (this.editAdminId === localStorage.getItem("boAdminId")) {
              ...
              localStorage.setItem("currentRole", this.roleAdminId);
              setTimeout(function() {
                var URLactual = window.location.origin;
                window.location = URLactual + "/admin";
              }, 1000);
            } else {
